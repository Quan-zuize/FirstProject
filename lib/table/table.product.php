 ...
 *           
 * @deprecated Không khuyến khích sử dụng nữa. Chưa loại bỏ hoàn toàn. Chưa cấm sử dụng.
 * Bởi vì bảng `product_related` hiện tại bị loại khỏi dự án để giảm sự phức tạp của database.
 */
...
// 		}
		...
		$featuredProducts[] = array(
			...
			'description_short' => utf8_substr(strip_tags(html_entity_decode($product['description'], ENT_QUOTES, 'UTF-8')), 0, settings('config_product_description_length')) . '..',
